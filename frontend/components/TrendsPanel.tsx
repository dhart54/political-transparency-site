...
export default function TrendsPanel() {
    return (
        <section className="w-full rounded-xl bg-white dark:bg-slate-900 shadow p-4 mb-6 flex flex-col items-center justify-center min-h-[120px]">
            <span className="inline-block mb-2 px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs font-semibold tracking-wide uppercase shadow-sm animate-pulse">
                Coming Soon
            </span>
